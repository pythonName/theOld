...
{
    [self.portraitImageView setImage:portrait forState:UIControlStateNormal];
}
...
- (id)initWithAnnotation:(id<MAAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        self.portraitImageView = [[UIButton alloc] initWithFrame:CGRectMake(kHoriMargin, kVertMargin, kPortraitWidth, kPortraitHeight)];
