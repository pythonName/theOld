...
- (void)viewDidLoad {
    ...
    //请输入新手机号
    self.phoneNumberTextField  = [[UITextField alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(tipV.frame), CGRectGetWidth(_frame), 55*ScreenHRatioBaseIphone6)];
    ...
    btn.frame = CGRectMake(CGRectGetWidth(self.phoneNumberTextField.frame)-80, 8*ScreenHRatioBaseIphone6, 80, CGRectGetHeight(self.phoneNumberTextField.frame)-2*8*ScreenHRatioBaseIphone6);
    ...
    [self.phoneNumberTextField addSubview:btn];
    //按钮左边框
    ...
    //分割线
    UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.phoneNumberTextField.frame), CGRectGetWidth(self.phoneNumberTextField.frame), 0.5)];
    line1.backgroundColor = UIColorFromRGB(0xdddddd);
    [self.view addSubview:line1];
    
    //请输入短信验证码
    self.nnphoneNumberTextField  = [[UITextField alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.phoneNumberTextField.frame), CGRectGetWidth(self.phoneNumberTextField.frame), CGRectGetHeight(self.phoneNumberTextField.frame))];
    ...
    self.loginBtn.frame = CGRectMake(0, CGRectGetMaxY(line2.frame) + 40, 297*ScreenWRatioBaseIphone6, CGRectGetHeight(self.phoneNumberTextField.frame));
